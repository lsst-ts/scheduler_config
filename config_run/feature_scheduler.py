...
if __name__ == 'config':
    ...
    surveys.append([fs.Pairs_survey_scripted(pairs_bfs, [1., 1., 1.], ignore_obs='DD', min_alt=20.,
                                            filt_to_pair='griz', max_slew_to_pair=120.)])
    ...
    for filtername in filters:
        ...
        weights = np.array([1., 1., 1., 1.0, 1.0, 0.5, 1., target_map_weights[filtername], 1.])
        surveys[-1].append(fs.Greedy_survey_fields(bfs, weights, block_size=1,
